      ...
      commands: [
        {
          ...
          desc: "Further details on the commands below are also included in the DM",
  ...
  const registerOptionsEmbed = new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        "  - Select and existing role from the server and the bot will make sure to ping that role whenever a new match is sent",
      ].join("\n")
    )
    .setFooter(domoHelpFoot);
