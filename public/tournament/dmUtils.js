  ...
  var message =
    voteData.entrant.length > 1
      ? "You voted **`" +
        ...
        "** tournament." +
        "\n> 1st Choice: **`" +
        voteData.entrant[0].title +
        " - " +
        voteData.entrant[0].name +
        "`**\n> 2nd Choice: **`" +
        voteData.entrant[1].title +
        " - " +
        voteData.entrant[1].name +
        "`**"
      : "You voted **" +
        voteData.vote +
        ": " +
        voteData.entrant.title +
        " - " +
        voteData.entrant.name +
        "** in match **" +
        voteData.match +
        "** of the **" +
        tournamentName +
...
async function SendRemovedVoteDm(interaction, db, voteData) {
  ...
  var message =
    "You have removed your vote from **`match " +
    voteData.match +
    "`** of the **" +
    tournamentName +
    "** tournament.";
